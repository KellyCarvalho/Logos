    ...
    <body>
        <section class="container">
            ...
            <div class="checkbox-inline" style="padding-top: 20px">
                <form:checkbox path="active" value="${categoryUpdateDTO.isActive() ? checked : unchecked}"  class="form-check-input" placeholder="Mostra ou deixa de mostrar a categoria na listagem dos alunos, de formações, etc" id="status" />
