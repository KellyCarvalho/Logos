                        ...
                        <c:forEach items="${categories}" var="category">
                            <li class="category-card">
                                <a href="category/${category.code}" class="category-card__link" href="/programacao">
                                    ...
                                    <c:forEach begin="0" varStatus="number" items="${category.subCategories}" end="2" var="subcategory">
                                        <p class="category-card__details">
                                            ${subcategory.name}<c:if test="${number.index < category.subCategories.size() -1}">,</c:if>
                                        </p>
                                    </c:forEach>
