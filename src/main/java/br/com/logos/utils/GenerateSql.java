...
public class GenerateSql {
    ...
    private static List<Category> categories = CsvReader.readCategories("files/planilha-dados-escola - Categoria.csv");
    private static List<SubCategory> subCategories = CsvReader.readSubCategories("files/planilha-dados-escola - Subcategoria.csv", categories);
    private static List<Course> courses = CsvReader.readCourses("files/planilha-dados-escola - Curso.csv", subCategories);
    ...
    public static void writeInsertSubCategories() {
        subCategories.forEach(subCategory -> {
            String sql = """
                    INSERT INTO Subcategory (`name`,`identifier_code`,`position`,`description`,`status`,`fk_category`) 
    ...
    public static void writeInsertCourses() {
        courses.forEach(course -> {
            String sql = """
                    INSERT INTO Course(`name`,`identifier_code`,`estimated_time`,`visibility`,`target_audience`,`instructor_name`,`description`,`developed_skills`,`fk_subcategory`)
